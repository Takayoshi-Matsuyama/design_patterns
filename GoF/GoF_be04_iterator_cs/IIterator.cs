...
/// <summary>
/// Represents the iterator interface that can traverse an aggregate object.
/// </summary>
...
public interface IIterator<T>
{
    ...
    /// </summary>
    /// <returns><c>true</c> if the iterator has reached the end; otherwise, <c>false</c>.</returns>
    bool IsDone();
