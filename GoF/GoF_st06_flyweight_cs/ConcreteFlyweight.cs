...
public class ConcreteFlyweight : IFlyweight
{
    ...
    /// <summary>
    /// Returns a string representation of the concrete flyweight, including its intrinsic state.
    /// </summary>
    /// <returns>A string representation of the concrete flyweight, including its intrinsic state.</returns>
    public override string ToString() => $"ConcreteFlyweight: IntrinsicState = {IntrinsicState}";
}
